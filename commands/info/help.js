...
module.exports = {
    config: {
        ...
        category: "info",
        description: "Displays all commands that the Spade has.",
    ...
    run: async (client, message, args) => {
        ...
        if (!args[0]) {
            ...
            embed.setDescription(stripIndents`**Spade Prefix Is \`${prefix}\`**\n
